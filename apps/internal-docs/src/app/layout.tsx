  ...
  return (
    <html lang="en">
      ...
      <body className={font.className} tabIndex={-1}>
        ...
        <Header />
        <div className="flex">
          {/* Relative spacing for sidebar on desktop */}
          <div className="min-w-72 max-w-72 relative hidden h-[calc(100vh-3.5rem)] lg:block" />
          <div className="relative right-0 top-0 w-screen lg:w-[calc(100vw-280px)]">

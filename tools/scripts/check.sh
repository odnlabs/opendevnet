...
function env_check() {
  ...
  variables=("ENVIRONMENT" "DEBUG" "PUBLIC_API_URL" "PUBLIC_WS_URL" "PUBLIC_SITE_URL" "PUBLIC_WEB_CLIENT_URL" "PUBLIC_INTERNAL_URL")

  required_http_vars=("PUBLIC_API_URL" "PUBLIC_SITE_URL" "PUBLIC_WEB_CLIENT_URL", "PUBLIC_INTERNAL_URL")
